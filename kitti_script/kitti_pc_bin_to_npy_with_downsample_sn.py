...
def process_kitti(input_root_path,
    ...
    for seq in seq_list:
        ...
        for i in range(sample_num):
            ...
            # open3d.geometry.estimate_normals(downpcd, search_param=open3d.geometry.KDTreeSearchParamHybrid(radius=sn_radius,
            #                                                                                       max_nn=sn_max_nn))
            ...
            # plt.show()
            # plt.savefig("test.png",tmp_img)
            # break



# 此函数通过将点云降采样，保存降采样后的[点云数据，点云法向量数据，反射强度]，维度为7*N
if __name__ == '__main__':
    # input_root_path = 'F:\\KITTI\\odometry\\dataset\\sequences'
    # output_root_path = 'F:\\KITTI\\odometry\\dataset\\sequences\\output'
    input_root_path = '../datas/kitti/sequences'
    output_root_path = '../datas/kitti/output'
