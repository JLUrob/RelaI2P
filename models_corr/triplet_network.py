...
from models_corr.pointTransformer.point_transformer import PointsEncoder_pointwise
from models_corr.network_img.resnet import Image_ResNet
from models_corr.spvnas.models.semantic_kitti.spvcnn import SPVCNN
...
class VP2PMatchNet(nn.Module):
    ...
    def forward(self,pc,intensity,sn,img):
        ...
        global_img_feat, pixel_wised_feat, pixel_wised_feat_0 = self.resnet(img)
        global_pc_feat, point_wised_feat, point_wised_feat_0 = self.point_transformer(input)
        ...
        # print(pixel_wised_feat_0.shape)
        # print(point_wised_feat_0.shape)
        # while(1):
        #     pass
        ...
        return pixel_wised_feat, point_wised_feat , img_score, pc_score, pixel_wised_feat_0, point_wised_feat_0
...
if __name__=='__main__':
    ...
    a,b,c,d,e,f=net(pc,intensity,sn,img)
    print(a.size())
    print(b.size())
    print(c.size())
    print(d.size())
