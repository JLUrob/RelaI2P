...
def test_acc_trans(model,testdataloader,args,logger):
    ...
    for step,data in enumerate(testdataloader):
        if step%1==0:
            ...
            img_features_all,pc_features_all,img_score_all,pc_score_all,pre_dist,feat_map=model(pc_all,intensity,sn,img,pcd_360_img,gt_dist)     #64 channels feature
...
if __name__=='__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='test', metavar='save_path',
                    help='path to save log and model')
    parser.add_argument('--exp_name', type=str, default='corrvp2p_360funsion_iter35_lr0.001', metavar='save_path',
                    help='path to save log and model')
    ...
    parser.add_argument('--neg_margin', type=float, default=1.8, metavar='neg_margin',
                        help='')
    parser.add_argument('--load_ckpt', type=str, default='./res/log_/mode_last.t7', metavar='save_path',
                    help='path to save log and model')
    ...
    log_name = args.load_ckpt.split('/')[-1]+'_log.txt'
    # print(log_name)
...
# CUDA_VISIBLE_DEVICES=0 python run_kitti_corr_360.py --load_ckpt='./res/corrvp2p_360funsion_iter35_lr0.001/mode_last.t7'
# CUDA_VISIBLE_DEVICES=1 python run_kitti_corr_360.py --load_ckpt='./res/corrvp2p_360funsion_iter35_lr0.001/mode_epoch_34.t7'
# CUDA_VISIBLE_DEVICES=2 python run_kitti_corr_360.py --load_ckpt='./res/corrvp2p_360funsion_iter35_lr0.001/mode_epoch_33.t7'
# CUDA_VISIBLE_DEVICES=3 python run_kitti_corr_360.py --load_ckpt='./res/corrvp2p_360funsion_iter35_lr0.001/mode_epoch_32.t7'
# CUDA_VISIBLE_DEVICES=0 python run_kitti_corr_360.py --mode='vis_registration' --load_ckpt='./res/corrvp2p_360funsion_iter35_lr0.001/mode_last.t7'
